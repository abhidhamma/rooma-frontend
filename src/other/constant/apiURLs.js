...
const CREATE_MEMBER_API_SLUG = 'company/member/add'
export const CREATE_MEMBER_API_URL = v1Url(CREATE_MEMBER_API_SLUG)
const DELETE_MEMBER_API_SLUG = 'company/member/delete'
export const DELETE_MEMBER_API_URL = v1Url(DELETE_MEMBER_API_SLUG)
const READ_MEMBER_LIST_API_SLUG = 'company/member/list'
export const READ_MEMBER_LIST_API_URL = v1Url(READ_MEMBER_LIST_API_SLUG)
...
const READ_AREA_LIST_API_SLUG = 'areacode/list'
export const READ_AREA_LIST_API_URL = v1Url(READ_AREA_LIST_API_SLUG)
...
const UPDATE_CLEANING_STATUS_SLUG = 'cleaning/save'
export const UPDATE_CLEANING_STATUS_URL = v1Url(UPDATE_CLEANING_STATUS_SLUG)
...
export const READ_RESERVATION_LIST_URL = v1Url(READ_RESERVATION_LIST_SLUG)

//정산관리
const READ_CALCULATE_RESERVATION_LIST_SLUG = 'calulate/reserve/list'
export const READ_CALCULATE_RESERVATION_LIST_URL = v1Url(READ_CALCULATE_RESERVATION_LIST_SLUG)

//청소관리
const READ_CLEANING_STATUS_LIST_SLUG = 'cleaning/schedule'
export const READ_CLEANING_STATUS_LIST_URL = v1Url(READ_CLEANING_STATUS_LIST_SLUG)
